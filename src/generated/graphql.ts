...
> = {
  ...
  themeCount?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['CMSThemeCount']>>>,
    ParentType,
    ContextType
  >
}
...
export type CmsThemeCountResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['CMSThemeCount'] = ResolversParentTypes['CMSThemeCount']
> = {
...
export type DatasetFilterResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['DatasetFilter'] = ResolversParentTypes['DatasetFilter']
> = {
  type?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type DatasetFilterOptionsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['DatasetFilterOptions'] = ResolversParentTypes['DatasetFilterOptions']
> = {
...
> = {
  ...
  cmsSearch?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryCmsSearchArgs, 'q' | 'input'>
  >
}
...
> = {
  __resolveType: TypeResolveFn<
    'DataSearchResult' | 'DatasetSearchResult' | 'CMSSearchResult',
    ParentType,
    ContextType
  >
  totalCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
...
> = {
  __resolveType: TypeResolveFn<
    'CMSSearchResultType' | 'DataSearchResultType',
    ParentType,
    ContextType
  >
  count?: Resolver<ResolversTypes['Int'], ParentType, ContextType>
